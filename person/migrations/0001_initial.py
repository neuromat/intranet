    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belongs_to', models.ForeignKey(verbose_name='Belongs to', blank=True, to='person.Institution',
                                                 null=True)),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citation_name', models.CharField(help_text='E.g.: Silva, J.', max_length=255, null=True,
                                                   verbose_name='Name in bibliographic citation', blank=True)),
                ...
                ('cpf', models.CharField(blank=True, max_length=15, null=True, verbose_name='CPF',
                                         validators=[person.models.validate_cpf])),
                ...
                ('street_complement', models.CharField(max_length=255, null=True, verbose_name='Complement',
                                                       blank=True)),
                ...
                ('institution', models.ForeignKey(verbose_name='Institution', blank=True, to='person.Institution',
                                                  null=True)),
            ],
            options={
                'ordering': ('full_name',),
