    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_nira_admin', models.BooleanField(default=False, help_text='Designates whether this user has special permissions, e.g. add content on behalf of another user.', verbose_name='NIRA admin')),
            ...
            options={
                ...
                'permissions': (('view_reports', 'Can see reports'), ('add_content', 'Can add contents'), ('create_documents', 'Can create documents')),
            },
        ),
    ]
