    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_activity', models.CharField(blank=True, max_length=1, verbose_name='Type of activity',
                                                      choices=[(b't', 'Training Program'),
                                                               (b'm', 'Meeting'), (b's', 'Seminar')])),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Meeting',
            fields=[
                ('projectactivities_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True,
                                                               serialize=False, to='activity.ProjectActivities')),
                ...
                ('participant', models.ManyToManyField(to='person.Person', null=True, verbose_name='Participant',
                                                       blank=True)),
            ],
            options={
                'ordering': ('-start_date',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('projectactivities_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True,
                                                               serialize=False, to='activity.ProjectActivities')),
                ('international_guest_lecturer', models.BooleanField(default=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(max_length=5, verbose_name='Duration',
                                              choices=[(b'1h', b'1h'), (b'1h30', b'1h30'), (b'2h', b'2h'),
                                                       (b'2h30', b'2h30'), (b'3h', b'3h'), (b'3h30', b'3h30'),
                                                       (b'4h', b'4h'), (b'4h30', b'4h30'), (b'5h', b'5h'),
                                                       (b'5h30', b'5h30'), (b'6h', b'6h'), (b'6h30', b'6h30'),
                                                       (b'7h', b'7h'), (b'7h30', b'7h30'), (b'8h', b'8h'),
                                                       (b'8h30', b'8h30'), (b'9h', b'9h'), (b'9h30', b'9h30'),
                                                       (b'10h', b'10h'), (b'Other', 'Other duration time')])),
                ('other_duration', models.CharField(help_text=b'E.g.: 11h or 11h30', max_length=5, null=True,
                                                    verbose_name='Other duration time', blank=True)),
                ('number_of_participants', models.IntegerField(null=True, verbose_name='Number of participants',
                                                               blank=True)),
