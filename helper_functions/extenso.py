# -*- coding: utf-8 -*-
#
# Agradecimentos ao Daemonio, do Daemoniolabs por esta implementação extremamente útil
# Basta passar um número em formato de string para que obter o numero escrito por extenso
#
